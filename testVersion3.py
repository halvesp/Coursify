...
def filtrar_cadeiras(niveis, areas, habilidades):
    ...
    for cadeira in base_de_conhecimento:
        if base_de_conhecimento[cadeira]["Nível de dificuldade"] in niveis and base_de_conhecimento[cadeira]["Área de estudo"] in areas and base_de_conhecimento[cadeira]["Habilidades específicas"] in habilidades:
...
check_desenvolvimento = tk.Checkbutton(frame_habilidades, text="Desenvolvimento de software", variable=var_desenvolvimento)
check_desenvolvimento.pack(side=tk.LEFT)

var_calculo = tk.BooleanVar()
check_calculo = tk.Checkbutton(frame_habilidades, text="Cálculo", variable=var_calculo)
check_calculo.pack(side=tk.LEFT)

var_banco_de_dados = tk.BooleanVar()
check_var_banco_de_dados = tk.Checkbutton(frame_habilidades, text="Banco de dados", variable=var_banco_de_dados)
check_var_banco_de_dados.pack(side=tk.LEFT)

var_sistemas = tk.BooleanVar()
check_sistemas = tk.Checkbutton(frame_habilidades, text="Sistemas", variable=var_sistemas)
